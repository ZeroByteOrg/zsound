...
The idea is to extend this with a BASIC wedge that defines BASIC commands which call the
API header instead of requiring SYS calls.
...
ZSM file names specify which emulator revision they are tuned for. ZSM will work
