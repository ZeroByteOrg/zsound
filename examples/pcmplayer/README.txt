...
ZCM is a new format for Zsound with the digitab parameters included in the header.
Use the raw2zcm tool in zsound/tools to add the header to a raw PCM file.
